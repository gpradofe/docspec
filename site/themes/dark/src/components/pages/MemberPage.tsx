      ...
      {method.returns && method.returns.type && method.returns.type !== "void" && (
        <div className="text-sm mb-2">
          ...
          {method.returns.description && (
            <span className="text-text-secondary ml-2">&mdash; {method.returns.description}</span>
          )}
        </div>
      )}
        ...
        <div className="text-sm">
          ...
          {method.throws.map((t, i) => (
            <React.Fragment key={i}>
              ...
              {t.description && <span className="text-text-secondary"> &mdash; {t.description}</span>}
            </React.Fragment>
          ))}
        </div>
      )}
