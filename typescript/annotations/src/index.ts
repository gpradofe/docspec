...
export { DocInvariant, DocMonotonic, DocConservation, DocOrdering, DocPreserves, DocCompare, DocRelation, DocBoundary, DocStateMachine, DocIdempotent, DocDeterministic, DocCommutative, DocIntentional, type DocInvariantOptions, type DocMonotonicOptions, type DocConservationOptions, type DocOrderingOptions, type DocCompareOptions, type DocRelationOptions, type DocBoundaryOptions, type DocStateMachineOptions } from "./decorators/doc-dsti.js";
