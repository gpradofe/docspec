...
function ArtifactCard({ artifact }: { artifact: ArtifactSummary }) {
  return (
    <a
      href={`/${artifact.slug}`}
      className="block p-5 rounded-lg border border-border hover:border-primary-500/50 hover:bg-surface-secondary transition-colors group"
    >
      <div className="flex items-center gap-3 mb-3">
        <h3 className="text-base font-semibold text-text-primary group-hover:text-primary-500">
          {artifact.label}
        </h3>
